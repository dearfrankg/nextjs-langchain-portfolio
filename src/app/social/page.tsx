    ...
    <section className="space-y-6">
      ...
      <section className="space-y-3">
        ...
        <ul className="list-inside list-disc space-y-1">
          <li>
            <a
              href="https://www.youtube.com/dearfrankg?sub_confirmation=1"
          ...
          <li>
            <a
              href="https://www.instagram.com/dearfrankg"
              className="text-primary hover:underline"
            >
              Instagram
            </a>
          ...
          <li>
            <a
              href="https://www.tiktok.com/@dearfrankg"
              className="text-primary hover:underline"
            >
              TikTok
            </a>
          ...
          <li>
            <a
              href="https://www.twitter.com/dearfrankg"
              className="text-primary hover:underline"
            >
              Twitter
            </a>
          ...
          <li>
            <a
              href="https://www.facebook.com/dearfrankg"
              className="text-primary hover:underline"
            >
              Facebook
            </a>
          ...
          <li>
            <a
              href="https://www.github.com/dearfrankg"
              className="text-primary hover:underline"
            >
              GitHub
            </a>
          ...
          <li>
            <a
              href="https://www.linkedin.com/in/dearfrankg"
              className="text-primary hover:underline"
            >
              LinkedIn
            </a>
          ...
          <li>
            <a
              href="https://www.dearfrankg.com/blog"
              className="text-primary hover:underline"
            >
              Blog
            </a>
      ...
      <section className="space-y-3">
        ...
        <p>
          I welcome you to{" "}
          <a
            href="https://dearfrankg.com/discord"
            className="text-primary hover:underline"
          >
      ...
      <section className="space-y-3">
        ...
        <p>
          ...
          <a
            href="mailto:dearfrankg@dearfrankg.com"
            className="text-primary hover:underline"
          >
            dearfrankg@dearfrankg.com
          </a>
        </p>
        <p>
